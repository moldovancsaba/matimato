...
- Quests, Ranks, History, and Profile use the same top-aligned feature screen rhythm: kicker, large title, controls, content. Large viewport filler must never push titles to the bottom of the panel.
